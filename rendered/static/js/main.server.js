...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentList = __webpack_require__(36);
	var CommentForm = __webpack_require__(39);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var commentNodes = this.props.comments.map(function (comment, index) {
	      return React.createElement(Comment, { author: comment.author, text: comment.text, key: index });
	    });
	    return React.createElement(
	      'div',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var marked = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { method: 'POST', action: this.props.url, onSubmit: this.handleSubmit },
	      React.createElement(
	        'h2',
	        null,
	        'Submit a comment'
