...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentListJsx = __webpack_require__(159);

	var _CommentListJsx2 = _interopRequireDefault(_CommentListJsx);

	var _CommentFormJsx = __webpack_require__(161);
		...
		_createClass(CommentBox, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(_CommentListJsx2['default'], { comments: this.props.comments }),
					_react2['default'].createElement(_CommentFormJsx2['default'], { url: this.props.url, xsrf: this.props.xsrf })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentJsx = __webpack_require__(160);
		...
		_createClass(CommentList, [{
			...
			value: function render() {
				...
				var commentNodes = this.props.comments.map(function (comment, index) {
					return _react2['default'].createElement(_CommentJsx2['default'], { author: comment.author, text: comment.text, key: index });
				});
				return _react2['default'].createElement(
					'div',
					null,
		...
		_createClass(CommentForm, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("input", { type: "hidden", name: "_xsrf", value: this.props.xsrf }),
					_react2["default"].createElement(
						"h2",
						null,
						"Submit a comment"
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							null,
							"Your hello",
							_react2["default"].createElement("input", { name: "author", type: "text", className: "form-control", placeholder: "..." })
						)
					),
					_react2["default"].createElement(
						"div",
						...
						_react2["default"].createElement(
							...
							null,
							"Say something...",
							_react2["default"].createElement("textarea", { name: "text", className: "form-control", placeholder: "..." })
						)
					),
					_react2["default"].createElement(
						"div",
